...
- age and age-group summaries (years)
- sex (male/female)
- HIV status (positive/negative) & ART status (yes/no)
- fever history (yes/no)
- cough ≥2 weeks history (yes/no)
- previous TB treatment (yes/no)
- previous household TB contact (yes/no)
- raw and nil-subtracted TB1, TB2, nil, and mitogen values (IU/mL)
- final QFT-Plus result (QFT-Plus software printout) (positive/negative/indeterminate)
...
Recommended citation: [![DOI](https://zenodo.org/badge/DOI/10.5281/zenodo.19390527.svg)](https://doi.org/10.5281/zenodo.19390527)
